  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className='space-y-6'>
      ...
      <button
        ...
        className="w-full bg-primary hover:bg-primary/80 active:scale-[0.98] text-background font-medium 
          font-bebas text-[22px] tracking-widest py-3 transition-all duration-100 rounded-none disabled:opacity-50 
          disabled:cursor-not-allowed flex flex-row items-center justify-center gap-2"
      >
        {isSubmitting ? (
          <>
