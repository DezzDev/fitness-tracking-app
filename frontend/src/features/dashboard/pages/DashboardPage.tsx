				...
				>
					...
					<div className="p-8">
						<button
							...
							className="w-full bg-primary hover:bg-primary/80 active:scale-[0.98] text-background font-medium font-bebas text-[22px] tracking-[4px] py-5 cursor-pointer transition-all duration-100"
						>
